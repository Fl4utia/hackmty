  ...
  return (
    <div className="font-serif">
      ...
      <main className="pt-20">
        ...
        <section id="overview" className="text-center py-20 bg-white">
          ...
          <div className="mt-10">
            <img
              ...
              src="https://imgur.com/9Qe5nd2.jpg"
              alt="Event planning"
            />
          </div>
        </section>
        ...
        <section
          id="story"
          className="flex flex-col-reverse lg:flex-row items-center py-20 bg-[#00303F] text-white"
        >
          <div className="w-full lg:w-1/2 p-8">
            <h2 className="text-4xl mb-4 text-center">Our Story</h2>
            <p className="text-lg leading-relaxed text-justify">
              FinVents was founded with a mission to provide financial
              transparency for major life events like weddings, graduations, and
              corporate events. In collaboration with Capital One, we aim to
              help people manage and track their event expenses, ensuring
              clarity and confidence in every financial decision. Whether it's a
              wedding, a graduation, or any special celebration, we're here to
          ...
          <div className="w-full lg:w-1/2 p-8">
            <img
              className="w-full"
              src="https://imgur.com/f1RsywD.png"
        ...
        <section id="events" className="py-20 bg-white text-center">
          ...
          <p className="mb-10">
            From weddings to graduations, we have you covered.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-8">
            <figure className="w-full">
              <img
                src="https://imgur.com/twqvpsQ.png"
                alt="Wedding"
            ...
            <figure className="w-full">
              <img
                src="https://imgur.com/7Bwtw2N.png"
                alt="Graduation"
                className="w-full h-64 object-cover"
              />
            ...
            <figure className="w-full">
              <img
                src="https://imgur.com/cwb7rrz.png"
                alt="Corporate Event"
                className="w-full h-64 object-cover"
              />
